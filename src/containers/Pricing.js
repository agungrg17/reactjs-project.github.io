                ...
                <Table aria-label="simple table">
                    ...
                    <TableFooter>
                        <TableRow>
                            <TableCell></TableCell>
                            <TableCell align="center">
                                <Button variant="contained" color='secondary' onClick={() => onSubscribed('bronze')}>
                                    Buy now
                                </Button>
                            </TableCell>
                            <TableCell align="center">
                                <Button variant="contained" color='secondary' onClick={() => onSubscribed('gold')}>
                                    Buy now
                                </Button>
                            </TableCell>
                            <TableCell align="center">
                                <Button variant="contained" color='secondary' onClick={() => onSubscribed('platinum')}>
                                    Buy now
                                </Button>
                            </TableCell>
                        </TableRow>
